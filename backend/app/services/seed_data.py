SEED_KNOWLEDGE_DOCUMENTS = [
    {
        ...
        "tags": {"severity": "CRITICAL", "category": "database"},
    },
    {
        "document_type": "error_code",
        "error_code": "MEM-503",
        ...
        "remediation_suggestion": "ROLLBACK_DEPLOYMENT",
        "tags": {"severity": "WARNING", "category": "resource"},
    },
    {
        "document_type": "error_code",
        "error_code": "LAT-504",
        ...
        "remediation_suggestion": "ROLLBACK_DEPLOYMENT",
        "tags": {"severity": "ERROR", "category": "latency"},
    },
    {
        "document_type": "guide",
        "error_code": None,
    ...
    },
    {
        ...
        "remediation_suggestion": "ROLLBACK_DEPLOYMENT",
        "tags": {"verified_resolution": "ROLLBACK_DEPLOYMENT", "resolution_status": "RESOLVED"},
    },
]
